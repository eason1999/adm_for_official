  ...
  <div class="monitor-devfile-wrapper">
    ...
    <div class="devfile-title-wrapper">
      ...
      <div class="dowm-forward">
        ...
        <el-select v-model="adType" filterable placeholder="请选择" v-loading.fullscreen.lock="loadings" element-loading-text="拼命加载中">
          <el-option
            v-for="item in types"
            :key="item.id"
            :label="item.text"
      ...
      <div class="dowm-forward">
        ...
        <el-select v-model="devId" @change="loadapps" filterable placeholder="请选择">
          <el-option
            v-for="item in devs"
            :key="item.id"
            :label="item.text"
